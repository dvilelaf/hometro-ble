from hometro_ble.vendor_oem import parse_oem_frame, xor_checksum
...
def test_parse_idle_frame() -> None:
    frame = parse_oem_frame(bytes.fromhex("02 51 00 51 03"))
...
def test_parse_countdown_frame() -> None:
    frame = parse_oem_frame(bytes.fromhex("02 51 02 03 50 03"))
